<template>
    ...
    <template v-if="!showEdite">
        <div class="flex items-center justify-between">
            ...
            <h3 v-if="form.start">زمان شروع آزمون: {{ form.start }}</h3>
            <h3 v-if="form.end">زمان پایان آزمون: {{ form.end }}</h3>
    ...
    <template v-if="showEdite">
        <div class="col-span-full md:w-1/2 lg:w-1/3">
            <my-label for="name" value="نام آزمون" :required="true" />
            <my-input
                id="name"
                type="text"
        ...
        <div class="grid grid-cols-3 gap-2">
            ...
            <div>
                <my-label for="time" value="مدت زمان آزمون" :required="true" />
                <my-input
                    id="time"
                    class="w-full"
                    v-model="form.time"
    ...
    <!-- Button Enable / Disable Quiztions-->
    <div class="mt-4">
        <my-button :loding="loding" type="button" @click="showQuiztions">
...
//Loding And Show Quiztions
const show = ref(false);
const loding = ref(false);
// Togeled Show Quiztions
